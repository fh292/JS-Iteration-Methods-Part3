...
******************************************************************/
const tempGreaterThan25 = temperatures.filter((number) => number >= 25);
console.log(tempGreaterThan25);

const tempLessThan20 = temperatures.filter((number) => number < 20);
...
******************************************************************/
const tempInF = temperatures.map((temp) => (temp * 9) / 5 + 32);
console.log(tempInF);

const labeledTemp = temperatures.map((temp) => {
  if (temp >= 25) return "Warm";
  else if (temp >= 20 && temp < 25) return "Mild";
  else return "Cool";
});
console.log(labeledTemp);
